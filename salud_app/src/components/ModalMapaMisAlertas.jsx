...
const ModalMapaMisAlertas = ({ data }) => {
    ...
    <View style={styles.container}>
        ...
        >
            <View key={item.srv_id}>
                <Text style={styles.title}>{item.alt_descripcion}</Text>
                <View style={styles.article}>
                    <Text style={styles.text}>{item.srv_solicitud}</Text>
                    <Text style={styles.text}>{item.alt_punto}</Text>
                    <Text style={styles.text}>{item.hor_codigo} - {item.hor_descripcion}</Text>
                    <Text style={styles.text}>Horario de {item.hor_de} a {item.hor_a}</Text>
                </View>
                <Text style={styles.footer}>Publicado {item.alt_registrado}</Text>
            </View>
        </TouchableOpacity>
    </View>
  );
  ...
  return (
    <View>
      <View style={styles.containerTip}>
          ...
          <View style={styles.article}>
              <Text style={styles.textTip}>Listado de todas "Mis Alertas" registradas.</Text>
          </View>
      </View>
      ...
      <FlatList
        ...
        keyExtractor={(item) => item.alt_id.toString()}
      />
      ...
      >
        <View style={styles.containerModal}>
          <View style={{ height: '60%', backgroundColor: styles.secondary }}>
            <Text style={styles.title}>Alerta {selectedItem && selectedItem.alt_descripcion}</Text>
...
export default ModalMapaMisAlertas;
