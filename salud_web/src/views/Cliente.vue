          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
              <div class="grid grid-cols-3 m-0">
                <div class="p-4 m-0">
                  <label for="cli_tcli_id">Tipo de Cliente</label>
                  <select v-model="reg.cli_tcli_id" class="form-control"
                    name="cli_tcli_id" id="cli_tcli_id"
              ...
              <div>
                <div class="col-md-6">
                  ...
                  <input
                    v-model="reg.cli_data.cli_paterno"
                    class="form-control"
                    name="paterno"
                    id="paterno"
                    placeholder="Paterno"
                ...
                <div class="col-md-6">
                  ...
                  <input
                    v-model="reg.cli_data.cli_materno"
                    class="form-control"
                    name="materno"
                    id="materno"
                    placeholder="Materno"
                ...
                <div class="col-md-6">
                  ...
                  <input
                    v-model="reg.cli_data.cli_nombres"
                    class="form-control"
                    name="nombres"
                    id="nombres"
                    placeholder="Nombres"
                ...
                <div class="col-md-6">
                  ...
                  <input
                    v-model="reg.cli_data.cli_telefono"
                    class="form-control"
                    name="telefono"
                    id="telefono"
                ...
                <div class="col-md-6">
                  ...
                  <input
                    v-model="reg.cli_data.cli_celular"
                    class="form-control"
                    name="celular"
                    id="celular"
                    placeholder="Celular"
                ...
                <div class="col-md-6">
                  ...
                  <input
                    v-model="reg.cli_data.cli_direccion"
                    class="form-control"
                    name="direccion"
                    id="direccion"
                ...
                <div class="col-md-6">
                  ...
                  <input
                    type="password"
                    v-model="reg.cli_data.cli_clave"
                    class="form-control"
                    name="clave"
                    id="clave"
                    placeholder="Clave"
    ...
    methods: {
      ...
      async saveModal() {
        ...
        if (this.isEditing) {
          ...
          this.regs[
            this.regs.findIndex((reg) => reg.cli_id === updatedReg.cli_id)
          ] = updatedReg;
        } else {
      ...
      async deleteRegistro(reg) {
        ...
        const indexL = this.regs.findIndex((regX) => reg.cli_id === regX.cli_id);
        console.log("Index: ", indexL);
        console.log("Data: ", this.regs[indexL]);
  
        this.reg.cli_usr_id = 1; // <----- Avito completar
        this.reg.cli_estado = "X";
        if (window.confirm("¿Estás seguro de eliminar este registro?")) {
          const savedReg = await clientesService.deleteData(this.reg);
