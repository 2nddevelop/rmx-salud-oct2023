  <template>
          ...
          <table class="table table-responsive">
            ...
            <tbody>
              <tr v-for="(r, index) in regs" v-bind:key="r.cli_id">
                ...
                <td align="right">{{ r.cli_nit }}</td>
                <td align="left">{{ r.cli_paterno }}</td>
                <td align="left">{{ r.cli_materno }}</td>
                <td align="left">{{ r.cli_nombres }}</td>
                <td align="right">{{ r.cli_telefono }}</td>
                <td align="left">{{ r.cli_direccion }}</td>
                <td align="left">{{ r.cli_fec_nac }}</td>
    ...
    import clientesService from '../services/clientesServiceSICE';
