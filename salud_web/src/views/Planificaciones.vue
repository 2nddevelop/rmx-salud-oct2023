        ...
        <table class="table table-responsive">
          ...
          <tbody>
            <tr v-for="(r, index) in regs" v-bind:key="r.pln_id">
              ...
              <td align="right">
                  {{ r.pln_data.pln_horario_inicio}}
              </td>
              <td align="right">
                  {{ r.pln_data.pln_horario_fin}}
              </td>
            </tr>
          </tbody>
          <tfoot>
            ...
            <div class="p-6 space-y-6">
              <div class="grid grid-cols-3 m-0">
                ...
                <div class="p-4 m-0">
                  ...
                  <input
                    type="date"
                    v-model="reg.pln_data.pln_fecha"
                    class="form-control"
                    name="fehca"
                    id="fecha"
                    placeholder="Fecha"
              ...
              <div>
                <div class="col-md-6">
                  ...
                  <input
                    v-model="reg.pln_data.pln_medico"
                    class="form-control"
                    name="medico"
                    id="medico"
                    placeholder="Medico"
                ...
                <div class="col-md-6">
                  ...
                  <input
                    v-model="reg.pln_data.pln_consultorio"
                    class="form-control"
                    name="consultorio"
                    id="consultorio"
                ...
                <div class="col-md-6">
                  ...
                  <input
                    type="number"
                    v-model="reg.pln_data.pln_max_fichas"
                    class="form-control"
                    name="fichas"
                    id="fichas"
                    placeholder="Max Fichas"
                  />
                </div>
                <div class="col-md-6">
                  <label for="horarioini">Inicio de Horario de Atención:</label>
                  <input
                    type="time"
                    v-model="reg.pln_data.pln_horario_inicio"
                    class="form-control"
                    name="horarioini"
                    id="horarioini"
                    placeholder="Inicio de Horario de Atención"
                  />
                </div>
                <div class="col-md-6">
                  <label for="horariofin">Fin de Horario de Atención:</label>
                  <input
                    type="time"
                    v-model="reg.pln_data.pln_horario_fin"
                    class="form-control"
                    name="horariofin"
                    id="horariofin"
                    placeholder="Fin de Horario de Atención"
                  />
                </div>
              </div>
            </div>
    ...
    methods: {
      async listarRegistros() {
        ...
        try {
          ...
          console.log("Planificaciones: ", this.regs);
        } catch (error) {
      ...
      async saveModal() {
        ...
        if (this.isEditing) {
          ...
          this.regs[
            this.regs.findIndex((reg) => reg.pln_id === updatedReg.pln_id)
          ] = updatedReg;
        } else {
      ...
      async deleteRegistro(reg) {
        ...
        const indexL = this.regs.findIndex((regX) => reg.pln_id === regX.pln_id);
        console.log("Index: ", indexL);
        console.log("Data: ", this.regs[indexL]);
  
        this.reg.pln_usr_id = 1; // <----- Avito completar
        this.reg.pln_estado = "X";
        if (window.confirm("¿Estás seguro de eliminar este registro?")) {
          const savedReg = await planificacionesService.deleteData(this.reg);
